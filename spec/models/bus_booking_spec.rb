...
describe BusBooking do
    ...
    it "should create a new instance given valid attributes" do
      BusBooking.create!(@valid_attributes)
    end

    it "should require seats_left" do
      bus = BusBooking.create(@valid_attributes.except(:seats_left))
      bus.should have_at_least(1).error_on(:seats_left)
    end   
end
